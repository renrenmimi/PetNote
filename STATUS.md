...
| #208 | `stack-2-core` `3f3fb95` | 在（两次修复都落在这一层：`059db25`、`e6a8eb8`） | `3f3fb95` 通过（CI 控制步骤和视频测试测量从顶层带下来：`7f30afa`、`3f3fb95`），包括「停掉媒体服务器后守卫报红」的对照 |
| #209 | `stack-3-models` `352fd8e` | 在（从 stack 2 合并上来） | `0870969` 通过（含对照）；`352fd8e`（宠物替身加锁）待看 |
| #210 / #204 | `feature/ios-native-prototype` `4437966` | 在 | `eb819c9` 两次都通过（含对照）；`44f8d99` 两次里 1 次测试进程崩溃（原因已查明并修复）；`4437966` 待看 |
