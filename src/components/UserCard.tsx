...
export function UserCard({ user, currentUid }: UserCardProps) {
  ...
  return (
    <div className="flex items-center justify-between rounded-2xl bg-white px-4 py-3 shadow-[0_18px_40px_-28px_rgba(15,23,42,0.4)] ring-1 ring-slate-100 transition-all duration-200 hover:-translate-y-0.5">
      <button
        type="button"
      ...
      >
        ...
        <div className="text-left">
          ...
          <p className="text-xs text-slate-400">{user.bio || "Pet lover"}</p>
        </div>
      </button>
