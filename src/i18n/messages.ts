...
const en = {
  ...
  "auth.noticeClose": "Close message",
  "auth.genericErrorTitle": "Something went wrong",
  ...
  "signup.heading": "Create your PetNote account",
  ...
  "signup.emailExistsTitle": "Email already registered",
  "signup.emailExistsMessage":
    "This email already has a PetNote account. Log in instead of creating a new one.",
  "signup.emailExistsAction": "Go to login",
  "signup.invalidEmailTitle": "Check your email",
  "signup.invalidEmailMessage": "Please enter a valid email address.",
...
const zh = {
  ...
  "auth.hide": "隐藏",
  "auth.emailPlaceholder": "you@example.com",
  "auth.noticeClose": "关闭提示",
  "auth.genericErrorTitle": "出错了",

  "login.badge": "欢迎回来",
  "login.heading": "登录你的账号",
  ...
  "signup.emailExistsTitle": "这个邮箱已经注册过",
  "signup.emailExistsMessage": "这个邮箱已经有 PetNote 账号了，请直接登录，不要重复注册。",
  "signup.emailExistsAction": "去登录",
  "signup.invalidEmailTitle": "请检查邮箱",
  "signup.invalidEmailMessage": "请输入有效的邮箱地址。",
